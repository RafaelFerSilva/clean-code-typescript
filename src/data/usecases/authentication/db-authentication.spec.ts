...
describe('DbAuthentication UseCase', () => {
  ...
  test('Should throw if LoadAccountByEmailRepository throws', async () => {
    const { sut, loadAccountEmailRepositoryStub } = makeSut()
    jest.spyOn(loadAccountEmailRepositoryStub, 'loadByEmail').mockReturnValueOnce(new Promise((resolve, reject) => { reject(new Error()) }))
  ...
  test('Should return null if LoadAccountByEmailRepository returns null', async () => {
    const { sut, loadAccountEmailRepositoryStub } = makeSut()
    jest.spyOn(loadAccountEmailRepositoryStub, 'loadByEmail').mockReturnValueOnce(null)
